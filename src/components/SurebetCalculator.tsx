        ...
        <div className="mt-2 p-3 rounded-xl border animate-slide-in bg-grafite-700/30 border-grafite-500">
          {isSurebet ? (
            <>
              ...
              <div className="mb-3">
                <label className="text-[10px] text-gray-500 mb-1 block">Valor total para investir:</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-3 py-2 bg-grafite-800 border border-grafite-500 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none focus:border-neon-green transition-colors"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2 mb-3">
                <div className="flex items-center justify-between p-2 bg-grafite-800 rounded-lg border border-grafite-500">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-[10px] text-gray-500">{homeShort} na {bestHomeHouse?.house}</p>
                      <p className="text-xs text-white font-bold">@ {bestHomeOdd.toFixed(2)}</p>
                    </div>
                  </div>
                  <p className="text-sm font-bold text-neon-green">R$ {homeStake.toFixed(2)}</p>
                </div>
                ...
                <div className="flex items-center justify-between p-2 bg-grafite-800 rounded-lg border border-grafite-500">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-[10px] text-gray-500">Empate na {bestDrawHouse?.house}</p>
                      <p className="text-xs text-white font-bold">@ {bestDrawOdd.toFixed(2)}</p>
                    </div>
                  </div>
                  <p className="text-sm font-bold text-neon-green">R$ {drawStake.toFixed(2)}</p>
                </div>
                ...
                <div className="flex items-center justify-between p-2 bg-grafite-800 rounded-lg border border-grafite-500">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-[10px] text-gray-500">{awayShort} na {bestAwayHouse?.house}</p>
                      <p className="text-xs text-white font-bold">@ {bestAwayOdd.toFixed(2)}</p>
                    </div>
                  </div>
                  <p className="text-sm font-bold text-neon-green">R$ {awayStake.toFixed(2)}</p>
                </div>
              </div>
              ...
              {stakeNum > 0 && (
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-neon-green/10 rounded-lg p-2 text-center border border-neon-green/20">
                    <p className="text-[9px] text-neon-green uppercase">Retorno Garantido</p>
                    <p className="text-base font-bold text-neon-green">R$ {guaranteedReturn.toFixed(2)}</p>
                  </div>
                  <div className="bg-neon-green/10 rounded-lg p-2 text-center border border-neon-green/20">
                    <p className="text-[9px] text-neon-green uppercase">Lucro Líquido</p>
            ...
            <div className="flex items-center gap-3 p-3">
              ...
              <div>
                <p className="text-xs text-gray-300">Sem arbitragem disponível</p>
